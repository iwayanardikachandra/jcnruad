...
<body>
  ...
  <section class="about">
    ...
    <div class="row">
      ...
      <div class="image">
        <img src="images/SATRIO PANEL SURYA.png" alt="">
      </div>

      <div class="content">
        <h3>Tentang PT. SATRIO PANEL SURYA</h3>
        <p>PT. SATRIO PANEL SURYA merupakan distributor dan perusahaan yang telah berpengalaman lebih dari 10 tahun di bidang panel surya (solar panel). Didukung oleh tim teknisi yang berpengalaman, memastikan solusi terbaik untuk Anda. Terdapat beberapa pilihan produk surya panel yang dapat sesuai dengan kebutuhan Anda
        </p>
  ...
  <section class="authors">
    ...
    <div class="box-container">
      <div class="box">
        <img src="images/Erla-team.png" alt="">
        <div class="share">
      ...
      <div class="box">
        ...
        <h3>Ananda Tita Firdausa</h3>
      </div>

      <div class="box">
        <img src="images/Nanda-team.png" alt="">
        <div class="share">
          <a href="#" class="fab fa-facebook-f"></a>
          <a href="#" class="fab fa-tiktok"></a>
          <a href="#" class="fab fa-instagram"></a>
        ...
        <h3>Qothrunnada Khalis</h3>
      </div>

      <div class="box">
        <img src="images/Gabriel-team.png" alt="">
        <div class="share">
          <a href="#" class="fab fa-facebook-f"></a>
          <a href="#" class="fab fa-tiktok"></a>
          <a href="#" class="fab fa-instagram"></a>
