      ...
      <div class="swiper home-slider">
        ...
        <div class="swiper-wrapper">
          ...
          <div class="swiper-slide slide">
            <div class="image">
              <img src="images/lampu_pju1.png" alt="">
            </div>
            <div class="content">
          ...
          <div class="swiper-slide slide">
            <div class="image">
              <img src="images/Lampu jalan1.png" alt="">
            </div>

            <div class="content">
              <span>Diskon Hingga 40%</span>
              <h3>Lampu Jalan LED Tenaga Surya </h3>
              <a href="shop.php" class="btn">Belanja</a>
            </div>
          </div>
          ...
          <div class="swiper-slide slide">
            <div class="image">
              <img src="images/lampu_sorot1.png" alt="">
            </div>
            <div class="content">
  ...
  <section class="category">
    ...
    <div class="swiper category-slider">
      ...
      <div class="swiper-wrapper">
        ...
        <a href="category.php?category=LAMPU SOROT " class="swiper-slide slide">
          <img src="images/icon-1.png" alt="">
          <h3>LAMPU SOROT </h3>
        </a>

        <a href="category.php?category=LAMPU TAMAN" class="swiper-slide slide">
        ...
        <a href="category.php?category=KULKAS TENAGA SURYA" class="swiper-slide slide">
          <img src="images/icon-5.png" alt="">
          <h3>KULKAS TENAGA SURYA</h3>
        </a>
